...
最新試作はChallenge Arsenal 0.5.0-challenge。Master §33とMomentum Briefの最新節を参照。3:4盤面・全弾待機・10秒連鎖・2銃・容量20の効果・3Stageと恒久Goldを小さく実装。以下の旧版記述は復元用。旧Build／Tag／Saveを保持し，検証は`.\scripts\momentum.ps1 verify`。
