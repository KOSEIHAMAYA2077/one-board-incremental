...
最新試作は0.6.1-drag。Master §33.11／Momentum Brief参照。Challengeの命中減速を2倍，高速時間減速を180/sにする比較Patch。初速・分裂・低速880/s・旧Labは保持。360度採掘／持ち帰り／拠点自動生産案はHandoffのみの未採用メモであり，今回は実装しない。
